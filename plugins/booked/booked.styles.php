...
if (!function_exists('electroserv_booked_get_css')) {
	add_filter('electroserv_filter_get_css', 'electroserv_booked_get_css', 10, 4);
	function electroserv_booked_get_css($css, $colors, $fonts, $scheme='') {
