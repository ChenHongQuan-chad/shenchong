...
if (!function_exists('electroserv_trx_addons_get_css')) {
	add_filter('electroserv_filter_get_css', 'electroserv_trx_addons_get_css', 10, 4);
	function electroserv_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.swiper-pagination-custom .swiper-pagination-button {
	...
	background-color: {$colors['text_dark_03']};
}
...
.sc_blogger .sc_blogger_item .post_meta_item:before {
	color: {$colors['text']};
}
...
.sc_googlemap_content .sc_icons .sc_icons_item_title,
.sc_googlemap_content .sc_icons .sc_icons_item_description {
	color: {$colors['bg_color']};
}
...
.sc_price .sc_price_item .sc_price_item_link.sc_button {
	background-color: {$colors['text_link']};
}
.sc_price .sc_price_item .sc_price_item_link.sc_button:hover {
	background-color: {$colors['text_hover']};
}
.sc_item_subtitle:before {
    color: {$colors['text_hover']};
}
.sc_title.scheme_dark .sc_item_subtitle:before {
    color: {$colors['text_hover']};
}
.sc_promo_descr i {
    color: {$colors['text_hover']};
...
.sc_form.color_style_dark .sc_form_title {
    color: {$colors['bg_color']};
}
.sc_form.color_style_dark input[type="text"], 
.sc_form.color_style_dark input[type="number"], 
.sc_form.color_style_dark input[type="email"], 
.sc_form.color_style_dark input[type="tel"], 
.sc_form.color_style_dark input[type="search"], 
.sc_form.color_style_dark input[type="password"], 
.sc_form.color_style_dark .select_container {
    color: {$colors['bg_color']};
    border-color: {$colors['alter_hover']};
    background-color: {$colors['alter_hover']};
}
.sc_form.color_style_dark input[type="text"]::-webkit-input-placeholder, 
.sc_form.color_style_dark input[type="number"]::-webkit-input-placeholder, 
.sc_form.color_style_dark input[type="email"]::-webkit-input-placeholder, 
.sc_form.color_style_dark input[type="tel"]::-webkit-input-placeholder, 
.sc_form.color_style_dark input[type="search"]::-webkit-input-placeholder, 
.sc_form.color_style_dark input[type="password"]::-webkit-input-placeholder, 
.sc_form.color_style_dark .select_container::-webkit-input-placeholder {
    color: {$colors['bg_color']};
}
.sc_form.color_style_dark input[type="text"]::-moz-placeholder, 
.sc_form.color_style_dark input[type="number"]::-moz-placeholder, 
.sc_form.color_style_dark input[type="email"]::-moz-placeholder, 
.sc_form.color_style_dark input[type="tel"]::-moz-placeholder, 
.sc_form.color_style_dark input[type="search"]::-moz-placeholder, 
.sc_form.color_style_dark input[type="password"]::-moz-placeholder, 
.sc_form.color_style_dark .select_container::-moz-placeholder {
    color: {$colors['bg_color']};
}
.sc_form.color_style_dark input[type="text"]:-ms-input-placeholder, 
.sc_form.color_style_dark input[type="number"]:-ms-input-placeholder, 
.sc_form.color_style_dark input[type="email"]:-ms-input-placeholder, 
.sc_form.color_style_dark input[type="tel"]:-ms-input-placeholder, 
.sc_form.color_style_dark input[type="search"]:-ms-input-placeholder, 
.sc_form.color_style_dark input[type="password"]:-ms-input-placeholder, 
.sc_form.color_style_dark .select_container:-ms-input-placeholder {
    color: {$colors['bg_color']};
}
.sc_form.color_style_dark input[type="text"]:-moz-placeholder, 
.sc_form.color_style_dark input[type="number"]:-moz-placeholder, 
...
.sc_form.color_style_dark .select_container:before {
    color: {$colors['bg_color']};
    border-color: {$colors['alter_hover']};
    background-color: {$colors['alter_hover']};
}
.sc_form.color_style_dark .select_container select {
    color: {$colors['bg_color']};
...
.sc_form.color_style_dark button {
    color: {$colors['text_dark']};
    background-color: {$colors['bg_color']};
}
.sc_form.color_style_dark button:hover {
    color: {$colors['bg_color']};
    background-color: {$colors['text_dark']};
}
...
.sc_services_hover .sc_services_item_content_inner .sc_button:hover {
