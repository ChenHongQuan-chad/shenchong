...
if (!function_exists('electroserv_customizer_get_css')) {

	function electroserv_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = electroserv_customizer_add_theme_fonts($fonts);
...
EOT;
			$rez = apply_filters('electroserv_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];

			
			// Border radius
			//--------------------------------------
			$rad = electroserv_get_border_radius();
			$rad50 = ' '.$rad != ' 0' ? '50%' : 0;
			$css['fonts'] .= <<<EOT
...
EOT;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(electroserv_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = electroserv_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = electroserv_customizer_add_theme_colors($colors);
...
.wp-caption-overlay .wp-caption .wp-caption-dd {
	color: {$colors['bg_color']};
	background-color: {$colors['text_hover_09']};
}
figcaption a {
    color: {$colors['text_dark']};
}
...
.sc_button_default.color_style_inverse,
...
.sc_button_default.color_style_inverse:hover,
.sc_button.color_style_inverse:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
	color: {$colors['bg_color']};
...
/* Contact Form 7 */
.wpcf7-form .color_style_dark input[type="text"],
.wpcf7-form .color_style_dark input[type="number"],
.wpcf7-form .color_style_dark input[type="tel"],
.wpcf7-form .color_style_dark input[type="email"],
.wpcf7-form .color_style_dark input[type="search"],
.wpcf7-form .color_style_dark input[type="password"],
.wpcf7-form .color_style_dark .select_container:before,
.wpcf7-form .color_style_dark .select_container select,
.wpcf7-form .color_style_dark textarea{
    color: {$colors['bg_color']};
    border-color: {$colors['alter_hover']};
    background-color: {$colors['alter_hover']} !important;
}

.wpcf7-form .color_style_dark input[type="text"]::-webkit-input-placeholder,
.wpcf7-form .color_style_dark input[type="number"]::-webkit-input-placeholder,
.wpcf7-form .color_style_dark input[type="tel"]::-webkit-input-placeholder,
.wpcf7-form .color_style_dark input[type="email"]::-webkit-input-placeholder,
.wpcf7-form .color_style_dark input[type="search"]::-webkit-input-placeholder,
.wpcf7-form .color_style_dark input[type="password"]::-webkit-input-placeholder {
	    color: {$colors['bg_color']};
}

.wpcf7-form .color_style_dark input[type="text"]::-moz-input-placeholder,
.wpcf7-form .color_style_dark input[type="number"]::-moz-input-placeholder,
.wpcf7-form .color_style_dark input[type="tel"]::-moz-input-placeholder,
.wpcf7-form .color_style_dark input[type="email"]::-moz-input-placeholder,
.wpcf7-form .color_style_dark input[type="search"]::-moz-input-placeholder,
.wpcf7-form .color_style_dark input[type="password"]::-moz-input-placeholder {
	    color: {$colors['bg_color']};
}

.wpcf7-form .color_style_dark input[type="text"]::-ms-input-placeholder,
.wpcf7-form .color_style_dark input[type="number"]::-ms-input-placeholder,
.wpcf7-form .color_style_dark input[type="tel"]::-ms-input-placeholder,
.wpcf7-form .color_style_dark input[type="email"]::-ms-input-placeholder,
.wpcf7-form .color_style_dark input[type="search"]::-ms-input-placeholder,
.wpcf7-form .color_style_dark input[type="password"]::-ms-input-placeholder {
	    color: {$colors['bg_color']};
}
...
.wpcf7-form .color_style_dark input[type="text"]::placeholder {
	    color: {$colors['bg_color']};
}

.wpcf7-form .color_style_dark input[type="tel"]::placeholder {
	    color: {$colors['bg_color']};
}

.wpcf7-form .color_style_dark input[type="email"]::placeholder {
	    color: {$colors['bg_color']};
}

.wpcf7-form .color_style_dark .select_container:after {
	color: {$colors['bg_color']};
}

.wpcf7-form .color_style_dark input[type="submit"] {
    color: {$colors['text_dark']};
    background-color: {$colors['bg_color']};
}
.wpcf7-form .color_style_dark input[type="submit"]:hover {
    color: {$colors['bg_color']};
    background-color: {$colors['text_dark']};
}
...
.sc_layouts_row_type_narrow a .sc_layouts_item_details_line2:hover,
.scheme_self.sc_layouts_row_type_narrow a .sc_layouts_item_details_line2 {
	color: {$colors['text_hover']};
}
...
.electroserv_tabs .electroserv_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.electroserv_tabs .electroserv_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sidebar .mejs-controls .mejs-button:hover,
.post_item_single .mejs-controls .mejs-button:hover {
	color: {$colors['bg_color']};
}
...
.post_item_single .post_content .post_meta_item:before {
    color: {$colors['text_hover']};
}
...
.menu_footer_nav_area ul ul li a:hover,
.footer_wrap .sc_layouts_menu > ul ul li a:hover {
	color: {$colors['alter_dark']};
}
...
EOT;
					...
					$rez = apply_filters('electroserv_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'electroserv_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>